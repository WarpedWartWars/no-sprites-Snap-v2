...
StageMorph.prototype = new Morph();
StageMorph.prototype.constructor = StageMorph;
StageMorph.uber = Morph.prototype;

// StageMorph preferences settings

StageMorph.prototype.dimensions = new Point(0, 0); // fallback unscaled ext
...
StageMorph.prototype.init = function (globals) {
    ...
    this.dimensions = new Point(0, 0); // unscaled extent
    this.instrument = null;
    ...
    this.scale = null; // for display modes, do not persist
