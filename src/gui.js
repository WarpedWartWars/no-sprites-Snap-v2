...
IDE_Morph.prototype.init = function (config) {
    ...
    this.currentSprite = this.scene.stage;
    this.sprites = null;
    this.currentCategory = this.scene.unifiedPalette ? 'unified' : 'lists';
    ...
    this.stageRatio = null; // for IDE animations, e.g. when zooming
...
IDE_Morph.prototype.createControlBar = function () {
    ...
    */
    ...
    this.controlBar.fixLayout = function () {
        ...
        [stopButton, pauseButton, steppingButton].forEach(button => {
        ...
        slider.setRight(steppingButton.left() - padding);
...
IDE_Morph.prototype.fixLayout = function (situation) {
    ...
    if (situation !== 'refreshPalette') {
        ...
        if (this.spriteEditor.isVisible) {
            this.spriteEditor.setLeft(cnf.noPalette ?
                this.left() + border
    ...
    if (Process.prototype.isCatchingErrors) {
        try {
            projectData = this.serializer.serialize(
                new Project(new List([this.scene]), this.scene)
            );
        } catch (err) {
...
IDE_Morph.prototype.hasUnsavedEdits = function () {
    return this.scene.hasUnsavedEdits;
};
...
IDE_Morph.prototype.recordSavedChanges = function () {
    this.scene.hasUnsavedEdits = false;
...
IDE_Morph.prototype.openProject = function (project) {
    ...
    this.switchToScene(
        project.currentScene || project.scene,
        true,  // refresh album
        null, // msg
        null, // data
...
IDE_Morph.prototype.setUnifiedPalette = function (bool) {
    ...
    this.currentCategory = bool ? 'unified' : 'lists';
    this.createCategories();
    this.createPaletteHandle();
    this.categories.fixLayout();
    this.fixLayout();
...
IDE_Morph.prototype.userSetBlocksScale = function () {
    ...
    scrpt.color = SpriteMorph.prototype.blockColor.looks;
...
IDE_Morph.prototype.buildProjectRequest = function () {
    var proj = new Project(new List([this.scene]), this.scene),
        body,
        xml;
...
IDE_Morph.prototype.exportProjectMedia = function (name) {
    ...
    if (name) {
        ...
        try {
            menu = this.showMessage('Exporting');
            this.serializer.serialize(new Project(new List([this.scene]), this.scene));
...
ProjectDialogMorph.prototype.buildContents = function () {
    ...
    if (this.task === 'save') {
        thumbnail = this.ide.scene.stage.thumbnail(
...
PaletteHandleMorph.prototype.render = function (ctx) {
...
PaletteHandleMorph.prototype.renderOn = function (
    ctx,
    color,
    shadowColor
) {
...
PaletteHandleMorph.prototype.mouseEnter = function () {
    this.userState = 'highlight';
    this.rerender();
};

PaletteHandleMorph.prototype.mouseLeave = function () {
    this.userState = 'normal';
    this.rerender();
};
